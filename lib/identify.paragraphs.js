...
const URL = require("paragraphs").URL
...
_immediate.method = "identify.paragraphs.i"

const identify_paragraphs = _.promise(_immediate)
...
identify_paragraphs.params = {
    paragraphs: _.is.normal,
}
identify_paragraphs.p = _.p(identify_paragraphs)
identify_paragraphs.i = _.i(_immediate)
