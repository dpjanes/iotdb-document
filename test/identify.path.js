...
describe("identify.path", function() {
    const tests = [
        ...
        {
            path: "/something/something/kittens.jpg",
    ...
    it("immediate", function() {
        tests.forEach(test => {
            const result = document.identify.path.i(test)
    ...
    it("parameterized", function(done) {
        _.promise()
            .then(document.identify.path.p("~david/file.jpg"))
            .make(sd => {
